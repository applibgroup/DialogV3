...
public class DialogSettings {
    ...
    public static boolean customDialog = false;

    public static boolean selectionDialog = false;

    public static boolean customInputDialog = false;

    public static boolean bottomMenuTitle = false;
    ...
    //对话框，全局按钮资源
    public static Element okButtonDrawable;
    public static Element cancelButtonDrawable;
    public static Element otherButtonDrawable;
